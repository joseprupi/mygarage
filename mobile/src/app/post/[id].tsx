...
const styles = StyleSheet.create({
  ...
  commentsTitle: { paddingHorizontal: 16, paddingVertical: 12, fontSize: 14, fontWeight: "700", color: "#334155" },
  comment: { flexDirection: "row", gap: 10, paddingHorizontal: 16, paddingVertical: 8 },
  commentAuthor: { fontSize: 14, fontWeight: "700", color: "#0b1120" },
  commentTime: { fontSize: 12, color: "#94a3b8", fontWeight: "400" },
  commentBody: { fontSize: 15, color: "#0b1120", marginTop: 2 },
  composer: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
