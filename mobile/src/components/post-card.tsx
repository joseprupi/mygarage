...
const styles = StyleSheet.create({
  ...
  author: { fontWeight: "700", fontSize: 17, color: "#0b1120" },
  vehicle: { fontSize: 14, color: "#64748b" },
  time: { fontSize: 14, color: "#94a3b8" },
  ...
  actionCount: { fontSize: 16, color: "#334155", fontWeight: "600" },
  caption: { paddingHorizontal: 16, paddingTop: 8, fontSize: 17, color: "#0b1120" },
});
