...
- [ ] FE-4 Missing CRUD (S–M): delete event/vehicle (F2), edit profile fields (F4), require content to publish (F7), **add VIN input to vehicle form** (F20 — vin is in schema + Specs but not editable; owner-requested).
