...
- [x] P5. **cececar.com live** (Cloudflare DNS + Firebase custom domain + SSL); CORS + Google OAuth origins include it. (`www` + `api.cececar.com` optional, pending.) Deploy scripts (`scripts/`) used for first real release.
