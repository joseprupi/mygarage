...
- [ ] P5. Custom domain + SSL (needs name/domain); add live origin to **Google OAuth** authorized JS origins (manual, console) so Google login works; update CORS for the domain.
