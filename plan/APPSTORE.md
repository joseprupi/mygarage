...
- [x] Privacy policy page → carfable.com/privacy (needs prod web deploy)
- [x] Support page → carfable.com/support (needs prod web deploy)
- [~] Sign in with Apple (required because Google login is offered) — in progress
- [~] Google login (waiting on owner: iOS OAuth client ID)
- [ ] Build 5 with all of the above → TestFlight sanity pass
...
## Android / Play Store
- [ ] EAS Android production build (AAB) — after login code lands; keystore auto-generated by EAS
